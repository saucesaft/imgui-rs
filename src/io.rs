...
pub struct Io {
    ...
    pub mouse_pos_prev: [f32; 2],
    pub mouse_clicked_pos: [[f32; 2]; 5],
    ...
    pub mouse_down_was_double_click: [bool; 5],
    pub mouse_down_duration: [f32; 5],
    pub mouse_down_duration_prev: [f32; 5],
    pub mouse_drag_max_distance_abs: [[f32; 2]; 5],
    pub mouse_drag_max_distance_sqr: [f32; 5],
    pub keys_down_duration: [f32; 512],
    pub keys_down_duration_prev: [f32; 512],
    pub nav_inputs_down_duration: [f32; NavInput::COUNT + NavInput::INTERNAL_COUNT],
    pub nav_inputs_down_duration_prev: [f32; NavInput::COUNT + NavInput::INTERNAL_COUNT],
    pub input_queue_characters: ImVector<sys::ImWchar>,
}
